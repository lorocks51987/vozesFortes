        ...
        <section id="producao-editorial" className="py-20 bg-gradient-section">
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                    {/* Podcast Section */}
                    <div className="bg-gradient-card p-5 sm:p-8 rounded-xl shadow-card hover-lift transition-smooth flex flex-col h-full w-full max-w-md mx-auto md:max-w-none md:mx-0">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="p-2.5 sm:p-3 bg-primary rounded-full">
                        ...
                        <img
                            ...
                            className="w-full max-w-full h-auto object-contain rounded-lg mb-4"
                        />
                    ...
                    <div className="bg-gradient-card p-5 sm:p-8 rounded-xl shadow-card hover-lift transition-smooth flex flex-col h-full w-full max-w-md mx-auto md:max-w-none md:mx-0">
                        ...
                        <img
                            ...
                            className="w-full max-w-full h-auto object-contain rounded-lg mb-4 sm:mb-6"
                        />
