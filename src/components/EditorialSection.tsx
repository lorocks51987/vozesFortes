import escritaImg from "@/assets/escrita.jpg";
        ...
        <section id="producao-editorial" className="py-20 bg-gradient-section">
            <div className="container mx-auto px-4">
                ...
                <div className="grid lg:grid-cols-2 gap-12">
                    {/* Podcast Section */}
                    <div className="bg-gradient-card p-8 rounded-xl shadow-card hover-lift transition-smooth">
                        ...
                        <img src={podcastImg} alt="Podcast Milagre Invisível" className="w-full h-56 object-cover rounded-lg mb-6" />
                    ...
                    <div className="bg-gradient-card p-8 rounded-xl shadow-card hover-lift transition-smooth">
                        ...
                        <img src={escritaImg} alt="Literatura Vozes Fortes" className="w-full h-56 object-cover rounded-lg mb-6" />
                        ...
                        <p className="text-muted-foreground leading-relaxed mb-6">
                            A primeira semente desse caminho é o livro Tempestade Interior, de nossa autoria, que inaugura essa jornada literária. A partir dele, o projeto se expande para a produção coletiva: textos inspirados em experiências reais, compilados em publicações que podem chegar tanto às mãos do leitor individual quanto a rodas de leitura, saraus e clubes literários.
                        </p>
                        <p className="text-muted-foreground leading-relaxed mb-6">
                        ...
                        <div className="bg-primary/5 p-6 rounded-lg mb-6 border-l-4 border-primary">
                            <img src={escritaImg} alt="Obra Tempestade Interior" className="w-full h-48 object-cover rounded mb-4" />
